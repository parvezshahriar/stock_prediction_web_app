...
dataset_name= st.sidebar.selectbox("Select Company Name",("Grameenphone","Brac","Beximco","Intech","Estern Bank","Dutch Bangla Bank","Desco","Bangas","All_Tex","Apex"))
Algorithm=st.sidebar.selectbox("Select Algorithm",("Linear Regression","SVM","Lstm"))


def get_dataset(dataset_name):
    if dataset_name=="Grameenphone":
        data=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\Grameenphone.xlsx")
    elif dataset_name=="Brac":
        data=data2=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\Brac bank.xlsx")
    elif dataset_name=="Intech":
        data=data2=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\Intech.xlsx")
    elif dataset_name=="Estern Bank":
        data=data2=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\Estern Bank.xlsx")
    elif dataset_name=="Dutch Bangla Bank":
        data=data2=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\Dutch Bangla Bank.xlsx")
    elif dataset_name=="Desco":
        data=data2=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\Desco.xlsx")
    elif dataset_name=="Bangas":
        data=data2=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\Bangas.xlsx")
    elif dataset_name=="All_Tex":
        data=data2=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\All_Tex.xlsx")
    elif dataset_name=="Apex":
        data=data2=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\Apex.xlsx")
    else:
        data=data3=pd.read_excel("C:\\Users\\User\\Desktop\\SHAILAS PROJECT\\Beximco.xlsx")
